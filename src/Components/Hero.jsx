      ...
      <Slider {...settings}>
        <div className=''>
          <div className='h-[650px] lg:h-[800px] relative overflow-hidden'>
            <img src={banner1} alt='Banner1' className='absolute inset-0 w-full h-full object-cover' loading='eager'/>
        ...
        <div className=''>
          <div className='h-[650px] lg:h-[800px] relative overflow-hidden'>
            <img src={banner2} alt='Banner 2' className='absolute inset-0 w-full h-full object-cover' loading='lazy'/>
               <div className='absolute inset-0 bg-black opacity-60'></div>
               <div className='relative max-w-7xl mx-auto'>
                <div className='flex h-[650px] justify-center items-center lg:pt-0 pt-20'>
                    <div className='flex flex-col space-y-8 justify-center items-center text-center px-5 md:px-0'>
        ...
        <div className=''>
          <div className='h-[650px] lg:h-[800px] relative  overflow-hidden' >
            <img src={banner3} alt='banner 3' className='absolute inset-0 w-full h-full object-cover'/>
               <div className='absolute inset-0 bg-black opacity-60'></div>
               <div className='relative max-w-7xl mx-auto'>
                <div className='flex h-[650px] justify-center items-center lg:pt-0 pt-20'>
                    <div className='flex flex-col space-y-8 justify-center items-center text-center px-5 md:px-0'>
